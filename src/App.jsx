        ...
        <div className="min-w-0 flex-1">
          ...
          {task.detail && (
            <>
              ...
              {needsTruncationButton && (
                <button onClick={() => setShowFullDetail(!showFullDetail)} className="text-xs text-indigo-500 hover:underline mt-1">
                  {showFullDetail ? 'ย่อ' : 'ดูรายละเอียดเพิ่ม'}
                </button>
              )}
            </>
          )}
